...
use Platform\Repositories\Common\LocaleRepository;
use Platform\Repositories\Common\CoreConfigRepository;
...
class Core
{
     ...
     * @return string
     */
    public function convertPrice(float $amount, string $targetCurrencyCode = null, string $orderCurrencyCode = null)
    {
     ...
     * @return string
     */
    public function formatPrice(float $price, string $currencyCode)
    {
     ...
     */
    public function getAccountJsSymbols(): array
    {
     ...
     * @return string
     */
    public function formatBasePrice(float $price = 0.00): string
    {
        $formater = new \NumberFormatter(app()->getLocale(), \NumberFormatter::CURRENCY);
     ...
     * @return bool
     */
    function is_empty_date($date): bool
    {
     ...
     * @return  string
     */
    public function formatDate(Carbon $date = null, string $format = 'd-m-Y H:i:s')
    {
        if (is_null($date)) {
            $date = Carbon::now();
        }
     ...
     * @return bool
     */
    public function DateInInterval(string $dateFrom = null, string $dateTo = null): bool
    {
     ...
     * @return string
     */
    public function xWeekRange(string $date, int $day): string
    {
        $ts = strtotime($date);
     ...
     * @return array
     */
    public function convertToAssociativeArray($items): array
    {
