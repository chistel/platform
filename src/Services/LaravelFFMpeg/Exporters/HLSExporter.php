...
use Platform\Services\LaravelFFMpeg\Traits\EncryptsHLSSegments;
use Closure;
...
class HLSExporter extends MediaExporter
{
	...
	private function cleanupSegmentPlaylistGuides(Media $media): self
	{
		...
		$this->pendingFormats->map(fn($formatAndCallback, $key) => $disk->delete($directory . static::generateTemporarySegmentPlaylistFilename($key)));
	 ...
	 *
	 * @param string|null $mainPlaylistPath
	 * @return MediaOpener
	 * @throws NoFormatException
	 */
